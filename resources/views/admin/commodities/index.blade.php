...
<head>
    <title>Manajemen Komoditas - Admin</title>
...
<body class="min-h-screen bg-gray-100">
    ...
    <header class="bg-gradient-to-r from-gray-800 via-red-900 to-gray-800 text-white py-6 shadow-lg">
        <div class="container mx-auto px-4">
            <h1 class="text-3xl font-bold text-center">MANAJEMEN DATA KOMODITAS</h1>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="py-4 px-4 text-center text-gray-500">Tidak ada data yang tersedia</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
